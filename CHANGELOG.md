...
### Added
- **Anchor Link Conversion**: Markdown anchor links (`[Section](#section-name)`) now become clickable internal links to headings in Google Docs
- New `utils.py` module with slugify and anchor link utilities
- Test suite for anchor link conversion
